...
Save_And_Exit () {
    cd /root/user-backup
    git config --global user.email "zairul.khu@gmail.com" &> /dev/null
...
link="https://raw.githubusercontent.com/zairulhyuk12/autoautoscript-bot-kenzo-kenzo/user-backup-db/main/$NameUser/$NameUser.zip"
sleep 1
