...
Exp=$(curl -sS https://raw.githubusercontent.com/zairulhyuk12/autoscript-bot-kenzo/ip-bot/main/ip-bot | grep $MYIP | awk '{print $3}')
fi
chck_b(){
...
curl -sS https://raw.githubusercontent.com/zairulhyuk12/script-bot/main/clgshow
echo -e "
"
fi
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
